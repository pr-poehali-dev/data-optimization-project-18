...
const testimonials = [
  {
    quote: "TeamHub полностью изменил то, как мы управляем доступом. Теперь добавить нового сотрудника и назначить ему роль занимает буквально минуту.",
    author: "Анна Петрова",
    role: "HR-директор, ТехноСтарт",
    image: "https://github.com/shadcn.png",
  },
  {
    quote: "Наконец-то есть понятная система ролей. Модераторы видят только своё, администраторы контролируют всё — порядок в команде навёден.",
    author: "Михаил Козлов",
    role: "Руководитель DigitalWave",
    image: "https://github.com/shadcn.png",
  },
]
